...
/* Author:                Shayna Haole, Tricia Holman, André Plath        */
...
VALUES (GET_TRANSACTION_SEQ, TO_DATE('02-05-2018', 'MM-DD-YYYY'), 'Purchase', 1091.94, 50.00, 2)
INTO WINE_TRANSACTION (Transaction_ID, Transaction_Date, Transaction_Type, Total_Cost, Shipping_Cost, Contact_ID)
VALUES (GET_TRANSACTION_SEQ, TO_DATE('02-15-2018', 'MM-DD-YYYY'), 'Sale', 110.00, 5.00, 7)
INTO WINE_TRANSACTION (Transaction_ID, Transaction_Date, Transaction_Type, Total_Cost, Shipping_Cost, Contact_ID)
VALUES (GET_TRANSACTION_SEQ, TO_DATE('02-20-2018', 'MM-DD-YYYY'), 'Purchase', 195.00, 15.00, 1)
INTO WINE_TRANSACTION (Transaction_ID, Transaction_Date, Transaction_Type, Total_Cost, Shipping_Cost, Contact_ID)
VALUES (GET_TRANSACTION_SEQ, TO_DATE('03-04-2018', 'MM-DD-YYYY'), 'Purchase', 129.00, 10.00, 3)
INTO WINE_TRANSACTION (Transaction_ID, Transaction_Date, Transaction_Type, Total_Cost, Shipping_Cost, Contact_ID)
VALUES (GET_TRANSACTION_SEQ, TO_DATE('03-11-2018', 'MM-DD-YYYY'), 'Sale', 35.00, 5.00, 8)
INTO WINE_TRANSACTION (Transaction_ID, Transaction_Date, Transaction_Type, Total_Cost, Shipping_Cost, Contact_ID)
VALUES (GET_TRANSACTION_SEQ, TO_DATE('03-25-2018', 'MM-DD-YYYY'), 'Purchase', 792.00, 40.00, 4)
INTO WINE_TRANSACTION (Transaction_ID, Transaction_Date, Transaction_Type, Total_Cost, Shipping_Cost, Contact_ID)
VALUES (GET_TRANSACTION_SEQ, TO_DATE('04-10-2018', 'MM-DD-YYYY'), 'Sale', 225.00, 10.00, 7)
INTO WINE_TRANSACTION (Transaction_ID, Transaction_Date, Transaction_Type, Total_Cost, Shipping_Cost, Contact_ID)
VALUES (GET_TRANSACTION_SEQ, TO_DATE('05-02-2018', 'MM-DD-YYYY'), 'Purchase', 372.00, 40.00, 5)
INTO WINE_TRANSACTION (Transaction_ID, Transaction_Date, Transaction_Type, Total_Cost, Shipping_Cost, Contact_ID)
VALUES (GET_TRANSACTION_SEQ, TO_DATE('05-06-2018', 'MM-DD-YYYY'), 'Sale', 30.00, 5.00, 9)
INTO WINE_TRANSACTION (Transaction_ID, Transaction_Date, Transaction_Type, Total_Cost, Shipping_Cost, Contact_ID)
VALUES (GET_TRANSACTION_SEQ, TO_DATE('05-06-2018', 'MM-DD-YYYY'), 'Sale', 30.00, 5.00, 11)
INTO WINE_TRANSACTION (Transaction_ID, Transaction_Date, Transaction_Type, Total_Cost, Shipping_Cost, Contact_ID)
VALUES (GET_TRANSACTION_SEQ, TO_DATE('05-19-2018', 'MM-DD-YYYY'), 'Purchase', 169.80, 30.00, 6)
INTO WINE_TRANSACTION (Transaction_ID, Transaction_Date, Transaction_Type, Total_Cost, Shipping_Cost, Contact_ID)
VALUES (GET_TRANSACTION_SEQ, TO_DATE('06-05-2018', 'MM-DD-YYYY'), 'Sale', 54.00, 5.00, 12)
SELECT * FROM dual;
